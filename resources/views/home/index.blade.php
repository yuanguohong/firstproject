...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" type="text/css" href="css/zjdHome/font-awesome.min.css">
    <link rel="stylesheet" type="text/css"  href="css/zjdHome/gonex-icons.css">
    <link rel="stylesheet" type="text/css" href="css/zjdHome/style.css">
</head>
<body>
...
<!--                    <img alt="zjd" src="/images/logo/zjdlogo.png">-->
                    <img alt="zjd" src="/images/svg/logo.svg">
...
<main>
    ...
    <section id="services">
        ...
        <div class="container">
            <p><h4>中聚德</h4></p>
            <p>&nbsp;</p>
            <p style="text-align: left;color: #555;text-indent: 2em;"></p>
            <p style="text-align: left;color: #555;text-indent: 2em;"></p>
        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="contact-info">
                        ...
                        <a href="tel:电话号码">
                            ...
                            <span class="data">18183263978</span>
...
<footer id="footer">
    ...
    <p class="copyright text-green"> © <span id="year">2018</span> - 中聚德 </p>
    <p class="copyright text-green"> 蜀ICP备17028327号 </p>
...
<script type="text/javascript" src="js/zjdHome/libs/smooth-scroll.min.js"></script>
<script type="text/javascript" src="js/zjdHome/libs/modernizr.mq.js"></script>
<script type="text/javascript" src="js/zjdHome/libs/mixitup.min.js"></script>
...
<!-- Custom JS -->
<script type="text/javascript" src="js/zjdHome/google-map.js"></script>
<script type="text/javascript" src="js/zjdHome/video.js"></script>
<script type="text/javascript" src="js/zjdHome/custom.js"></script>
